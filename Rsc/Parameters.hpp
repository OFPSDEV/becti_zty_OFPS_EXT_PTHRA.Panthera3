class Params {
	...
	class CTI_ECONOMY_STARTUP_FUNDS_EAST_COMMANDER {
		...
		values[] = {40000,50000,60000,70000,80000,90000,100000,125000,150000,200000,20000000};
		texts[] = {"$40000","$50000","$60000","$70000","$80000","$90000","$100000","$125000","$150000","$200000","$20000000"};
		default = 200000;
	};
