...
/* Civilian vehicles should be in towns...
...
_c = _c + ['CUP_B_HMMWV_Unarmed_USMC'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [200];
_t = _t + [10];
...
_c = _c + ['CUP_B_HMMWV_Ambulance_USMC'];
_p = _p + [''];
_n = _n + [(format ["Mobile Respawn - Range %1 m",CTI_RESPAWN_MOBILE_RANGE])];
_o = _o + [3000];
_t = _t + [10];
...
_c = _c + ['CUP_B_HMMWV_Avenger_USMC'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [5000];
_t = _t + [10];
...
_c = _c + ['CUP_B_HMMWV_Crows_M2_USA'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [800];
_t = _t + [10];
...
_c = _c + ['CUP_B_HMMWV_Crows_MK19_USA'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [900];
_t = _t + [10];
...
_c = _c + ['CUP_B_HMMWV_DSHKM_GPK_ACR'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [800];
_t = _t + [10];
...
_c = _c + ['CUP_B_HMMWV_Transport_USA'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [300];
_t = _t + [10];
...
_c = _c + ['CUP_B_HMMWV_Terminal_USA'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [300];
_t = _t + [10];
...
_c = _c + ['CUP_B_M1126_ICV_M2_Desert'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [7000];
_t = _t + [10];
...
_c = _c + ['CUP_B_M1126_ICV_MK19_Desert'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [8000];
_t = _t + [10];
...
_c = _c + ['CUP_B_M1129_MC_MK19_Desert'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [15000];
_t = _t + [10];
...
_c = _c + ['CUP_B_M1130_CV_M2_Desert'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [9000];
_t = _t + [10];
...
_c = _c + ['CUP_B_M1135_ATGMV_Desert'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [9000];
_t = _t + [10];
...
_c = _c + ['CUP_B_M1A1_Woodland_US_Army'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [30000];
_t = _t + [20];
...
_c = _c + ['CUP_B_M1A2_TUSK_MG_US_Army'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [35000];
_t = _t + [20];
...
_c = _c + ['CUP_B_M6LineBacker_USA_W'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [9000];
_t = _t + [20];
...
_c = _c + ['CUP_B_SA330_Puma_HC2_BAF'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [5000];
_t = _t + [20];
