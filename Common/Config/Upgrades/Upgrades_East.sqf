...
_a=_a	+			[true];
_c=_c +			[[15000, 20000, 30000, 45000, 70000]];
_lev=_lev+	[5];
_lin=_lin+	[[[],[],[],[],[]]];
_t=_t+			[[40*CTI_UPGRADE_RATIO, 60*CTI_UPGRADE_RATIO, 80*CTI_UPGRADE_RATIO, 100*CTI_UPGRADE_RATIO, 120*CTI_UPGRADE_RATIO]];
