...
CTI_MARKERS_UNITS_DEAD_DELAY = 30;  //30 seconds prevents a player from rearming on his dead body, since respawn is 30sec.
CTI_MARKERS_VEHICLES_DEAD_DELAY = 120;
