...
"]];
player createDiaryRecord ["Dev",["Contact Spanish","Any comment or remarks? Or you did find a bug or an exploit?<br /><br />Contact the author through:<br/><br />
- the GitHub Page https://github.com/SpanishSurfer/becti_zerty_OFPS.Altis<br/>
- at www.ofps.net"]];
player createDiaryRecord ["Dev",["Github","https://github.com/SpanishSurfer/becti_zerty_OFPS.Altis"]];
